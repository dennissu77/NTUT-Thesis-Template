...
All experiments in this study were conducted on the same physical host machine, whose hardware and operating system specifications are listed in Table~\ref{tab:host-spec}.
...
\begin{table*}[htbp]
    ...
    \renewcommand\arraystretch{1.5}{
        ...
        Memory & 48 GB DDR4 \\
        \hline
        Storage & ADATA SX8200PNP 480GB NVMe SSD \\
        \hline
