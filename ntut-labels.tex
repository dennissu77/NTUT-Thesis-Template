...
\newcommand\cTitle{非合作式 PCI 設備模擬}

% 我的姓名（中文）
% My Name（Chinese）
\newcommand\myCname{蘇翊端}

% 指導教授的姓名 (中文)，使用頓號隔開 
% Advisor (Chinese), use “、” to separate names
\newcommand\advisorCname{賴冠廷\ \ 博士}
...
\newcommand\eTitle{Non-cooperative PCI Device Emulation}

% 我的姓名（英文）
% My Name（English）
\newcommand\myEname{Yi-Tuan Su}
...
\newcommand\advisorEname{Kuan-Ting Lai, Ph.D.}
...
\newcommand\fulldeptEname{Department of Electronic Engineering}

\newcommand\deptEname{Electronic Engineering}
